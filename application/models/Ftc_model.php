  ...
  //       private $stbl_company                       = "stbl_company";
        ...
        **************************************************************/
        ...
        function getUnits($id){
            ...
            //    $this->db->select('Units.subunits_id, Subunits.subunit_name, Subunits.id');
    ...
    function get_all_Questions(){
        $this->db->select('Question.*,Category.category_name,Course.course, Units.*, Subunits.subunit_name'); 
        ...
        $this->db->join('ftc_units_master Units', 'ON Units.id = Question.unit_id');
        $this->db->join('ftc_sub_units_master Subunits', 'ON Subunits.id = Question.subunit_id');
    ...
    function get_question_info($id=''){
        $this->db->select('Question.*,Units.unit, Subunits.subunit_name'); 
        $this->db->from('ftc_questions_master Question ');
        $this->db->join('ftc_units_master Units', 'ON Units.id = Question.unit_id');
        $this->db->join('ftc_sub_units_master Subunits', 'ON Subunits.id = Question.subunit_id');
    ...
    function get_all_users(){
        $this->db->select('Users.*, Country.country_name');
        $this->db->from('ftc_user_profile_master  Users');
        $this->db->join('ftc_country_master Country', 'ON Country.id = Users.country_id');
    ...
    function updateUserStatus($id, $status){
        ...
        if($this->db->update('ftc_user_profile_master')){
            return true;
        }else{
            return false;
        }

		...
		<div class="sidebar-inner leftscroll">
			...
			<div id="sidebar-menu">
				...
				<ul>
					...
					<li class="submenu">
						<a class="<?php echo isset($class) && $class=='dashboard'? 'active' : ''; ?>"  href="<?php echo base_url().INDEX_PHP.'ftcinternational'; ?>"><i class="fa fa-fw fa-tachometer"></i><span> Dashboard </span> </a>
					</li>
					...
					<li class="submenu">
						<a class="<?php echo isset($class) && $class=='users'? 'active' : ''; ?>"  href="javascript:void(0);"><i class="fa fa-fw fa-book"></i> <span> Users </span> <span class="menu-arrow"></span></a>
						<ul class="list-unstyled">
							<li><a href="<?php echo base_url().INDEX_PHP.'ftcinternational/users'; ?>">View</a></li>
						</ul>
					</li>
